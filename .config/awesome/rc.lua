      ...
      grabber =
        awful.keygrabber.run(
          function(_, key, event)
            ...
            if     key == "h" then awful.spawn.with_shell(terminal .. " -e htop")
            elseif key == "n" then awful.spawn.with_shell(terminal .. " -e neofetch")
            end
            awful.keygrabber.stop(grabber)
            end
          )
        end,
        {description = "followed by KEY", group = "Chords"}
        ),
...
-- {{{ Personal keybindings
    awful.key({ modkey }, "t", function() awful.util.spawn("zathura ~/Desktop/Timetable.pdf") end,
        { description = "School timetable", group = "super" }),
    ...
    awful.key({ modkey }, "Delete", function() naughty.destroy_all_notifications() end,
        { description = "Destroy all notifications", group = "super" }),
    -- Function keys
    awful.key({}, "F12", function() awful.util.spawn("tdrop -a -w 60% -h 60% -x 20% -y 0 alacritty") end,
    ...
    -- ctrl + space
    awful.key({ modkey1 }, "space", function() awful.util.spawn("rofi -show drun") end,
        { description = "Application drawer (rofi)", group = "function keys" }),
    ...
    awful.key({ modkey1, altkey }, "o", function() awful.spawn.with_shell("$HOME/.scripts/picom-toggle.sh") end,
...
clientkeys = my_table.join(
    ...
    awful.key({ modkey, "Shift" }, "m", function(c) c:swap(awful.client.getmaster()) end,
        { description = "Make master", group = "client" }),
...
client.connect_signal("manage", function(c)
    -- Do not allow any window to be maximized when opened.
