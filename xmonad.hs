...
myKeys conf@(XConfig {XMonad.modMask = modMask}) = M.fromList $
  ...
  [ ((modMask, xK_e), spawn $ "neovide --multigrid" )
  ...
  , ((controlMask, xK_space ), spawn "/home/agastya/Scripts/switch.sh")
...
--  , ((0, xF86XK_AudioStop), spawn $ "mpc stop")
  ...
  , ((controlMask .|. shiftMask , xK_y), withFocused $ windows . W.sink)
...
main = do
   ...
   -- Request access to the DBus name
    ...
    xmonad . ewmh $ myBaseConfig {
        ...
        modMask = myModMask,
        -- layoutHook = gaps [(U,10), (D,10), (R,10), (L,10)] $ myLayout ||| Full,
        layoutHook = myLayout,
